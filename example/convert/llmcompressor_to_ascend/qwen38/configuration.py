...
class Qwen4ExpTextConfig(PreTrainedConfig):
    ...
    base_model_ep_plan: ClassVar[dict[str, str]] = {
    ...
    base_model_fsdp_plan: ClassVar[dict[str, str]] = {
    ...
    def __post_init__(self, **kwargs):
        ...
        # The real checkpoint contains "full_attention" entries for layers that are actually using an indexer
            ...
            self.layer_types = ["full_attention" if layer == "full_attention" else layer for layer in self.layer_types]

        super().__post_init__(**kwargs)

    def validate_architecture(self):
        """Part of `@strict`-powered validation. Validates Qwen4-Exp architecture invariants."""
        unsupported_layer_types = sorted(set(self.layer_types) - {"linear_attention", "full_attention"})
